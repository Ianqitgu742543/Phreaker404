...
Add_iptables(){
		...
		iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1443:1543 -j ACCEPT
                iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1732 -j ACCEPT
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/Ianqitgu742543/Phreaker404/main/ssrmu.sh"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/Ianqitgu742543/Phreaker404/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/Ianqitgu742543/Phreaker404/main/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/Ianqitgu742543/Phreaker404/main/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/Ianqitgu742543/Phreaker404/main/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/Ianqitgu742543/Phreaker404/main/renewssr.sh && chmod +x /usr/bin/renewssr
